                        ...
                        <td className="py-3 px-5 border-b border-blue-gray-50">
                          <div className="w-10/12">
                            ...
                            <div className="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                              <div
                                className="flex justify-center items-center h-full bg-gradient-to-tr w-[60%] from-blue-600 to-blue-400 text-white"
                      ...
                      <tr>
                        ...
                        <td className="py-3 px-5 border-b border-blue-gray-50">
                          <div className="w-10/12">
                            ...
                            <div className="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                              <div
                                className="flex justify-center items-center h-full bg-gradient-to-tr w-[10%] from-blue-600 to-blue-400 text-white"
                      ...
                      <tr>
                        ...
                        <td className="py-3 px-5 border-b border-blue-gray-50">
                          <div className="w-10/12">
                            ...
                            <div className="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                              <div
                                className="flex justify-center items-center h-full bg-gradient-to-tr w-full from-green-600 to-green-400 text-white"
                      ...
                      <tr>
                        ...
                        <td className="py-3 px-5 border-b border-blue-gray-50">
                          <div className="w-10/12">
                            ...
                            <div className="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                              <div
                                className="flex justify-center items-center h-full bg-gradient-to-tr w-[25%] from-blue-600 to-blue-400 text-white"
